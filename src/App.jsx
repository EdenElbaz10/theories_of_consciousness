...
const theoryClaims = {
  RPT: [
    ...
    "UC learning should be impossible (2)",
  ...
  GNW: [
    ...
    "There should be higher activation (in PFC) and synchrony (between PFC and category-selective areas) in gamma/beta for seen (vs unseen) stimuli (1; 15; 16)",
    ...
    "Unless the content of C is actively maintained in WM, neural activity in the GW should go back to baseline after ignition (12; 16)",
    "Onset/Offset to tag appearance and disappearance of stimulus within C, if stimulus is attended (16)",
    "Frontoparietal area, held to be involved in attentional processes and global exchange of info, should be one of the areas of implementation of GW (1)",
    "Decoding of all contents of C should be possible from PFC, and higher for seen (vs unseen) stimuli (15; 16)",
    ...
    "Incoming information that fails to attain the critical threshold level for triggering the GW (‘failed ignition’) should not be C (11; 16)",
    ...
    "AMPA receptors modulate feedforward connections while NMDA receptors modulate feedback connectivity, making them necessary for C (17)",
  ...
  IIT: [
    ...
    "Every distinction that is consciously experienced should be manifested in the CES for as long as it is experienced (8; 12; 13)",
    ...
    "Deactivating already inactive neurons of retinotopic cortex should remove part of spatial experience (10)",
    "Experience of “pure presence” should exhibit largely inactive posterior cortex (11)",
    "Expert meditators experiencing “pure presence” should exhibit decrease in gamma band, especially in posterior areas (11)",
    "Network that corresponds to content of C should be actively maintained for the duration of that content in C (13)",
    "There should be content specific synchronization between high-level and low-level areas in the posterior cortex regardless of the task (12; 13)",
    "Local strengthening or weakening of horizontal connections in topographic areas should lead to a local distortion of experienced visual space (10)",
    "Conscious perception overflows report (1; 14)",
    "All features of a consciously perceived stimulus should be maximally decodable from posterior areas, regardless of task (4; 12; 13)",
    ...
    "C is extremely rich (i.e., highly structured) (14)",
    ...
    "When c-e powers of neuronal populations are incongruent with c-e powers of the PSC, corresponding stimulus should remain unconscious (9)",
    "Temporal structure of experience should map into features specified by neurons organized in directed grids (15)",
    "Modulation of synaptic strength/ excitability of neurons in directed grids should change properties of phenomenal flow regardless of activity levels (15)",
    "Duration of the extended present should be proportional to the number of neurons constituting a directed grid (15)",
    "Artificial activation of neurons near the “then” terminus in a directed grid should result in perceiving a stimulus as having occurred earlier (15)",
    "Similarity metrics should be higher for content specific activation than task-specific activation in some posterior areas (12)",
    "Because mental action is not essential to consciousness, in a MIB task actively looking for a stimulus should not facilitate conscious access (10)",
  ],
  PRM: [
    ...
    "Subjects believe that C is richer than it is actually is (4; 5)",
    ...
    "Perception doesn’t overflow reportability (4)",
    ...
    "Phenomenological control should be able to alter reliability of FOS, but not their content (9)",
    ...
    "Adaptation should affect reality monitoring system, leading to shifts in awareness without changes in discrimination performance (9)",
    "Cross-decoding of neural populations responsible for perceptual and imagery vividness should be weak or absent (9)",
  ],
